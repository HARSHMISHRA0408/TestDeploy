...
const CandidateDashboard = ({ user }) => {
  if (!user) {
    // If user is undefined, show loading content or a placeholder
          ...
          <table className="min-w-full bg-gray-50 rounded-lg overflow-hidden">
            <tbody>
              ...
              <tr>
                ...
                <td className="px-6 py-4 text-gray-600">{user?.knowledgeArea || 'N/A'}</td>
              </tr>
              <tr>
                <td className="px-6 py-4 text-gray-800 font-medium capitalize">
                  Category
                </td>
                <td className="px-6 py-4 text-gray-600">{user?.category || 'N/A'}</td>
              </tr>
              <tr>
                <td className="px-6 py-4 text-gray-800 font-medium capitalize">
                  Registration Date
                </td>
                <td className="px-6 py-4 text-gray-600">{user?.registrationDate || 'N/A'}</td>
              </tr>
            </tbody>
          </table>
        </div>
